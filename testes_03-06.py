...
# #copiando parte do conteúdo, incluindo o último
...
# #Otras maneiras de fatiamento (omissao do star ou do end)
# my_list = ["A", "B", "C" ,"D", "E", "F"]
# print(my_list)
# new_list = my_list[:3]
# print(new_list)
...
#Testando se alguns itens existe em uma lista ou não 
